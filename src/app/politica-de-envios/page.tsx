...
export default function Shipping() {
  return (
    <main className="mx-auto max-w-4xl px-4 py-16">
      <h1 className="text-3xl font-bold text-gray-900">Política de Envíos</h1>
      <p className="mt-4 text-cami-300">Última actualización: 26 de mayo de 2026</p>

      <section className="mt-8">
        <h2 className="text-xl font-semibold text-gray-900">1. Ámbito</h2>
        <p className="text-sm text-cami-300">Esta política regula los plazos, costes y condiciones de envío aplicables a los pedidos realizados en {brandConfig.displayName}. Se aplica a envíos dentro de España peninsular y, cuando proceda, a envíos internacionales según se indique en la ficha del producto.</p>
      </section>

      <section className="mt-6">
        <h2 className="text-xl font-semibold text-gray-900">2. Plazos de preparación</h2>
      ...
      <section className="mt-6">
        <h2 className="text-xl font-semibold text-gray-900">3. Transporte y entrega</h2>
      ...
      <section className="mt-6">
        <h2 className="text-xl font-semibold text-gray-900">4. Costes de envío</h2>
      ...
      <section className="mt-6">
        <h2 className="text-xl font-semibold text-gray-900">5. Seguimiento</h2>
        <p className="text-sm text-cami-300">Recibirás un email con el número de seguimiento una vez el pedido salga del almacén. Si no recibes este email en el plazo indicado, contacta con nosotros en <a href={`mailto:${brandConfig.supportEmail}`} className="text-cami-200 underline">{brandConfig.supportEmail}</a>.</p>
      </section>

      <section className="mt-6">
        <h2 className="text-xl font-semibold text-gray-900">6. Incidencias, daños y pérdidas</h2>
      ...
      <section className="mt-6">
        <h2 className="text-xl font-semibold text-gray-900">7. Cambio de dirección y reenvío</h2>
      ...
      <section className="mt-6">
        <h2 className="text-xl font-semibold text-gray-900">8. Fuerza mayor</h2>
