  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-16">
      ...
      <section className="mt-8">
        ...
        <p className="text-sm text-cami-300">Estos Términos y Condiciones regulan el uso del sitio web y la contratación de productos ofrecidos por {brandConfig.displayName} a través de https://camiart.com.</p>
      </section>
      ...
      <section className="mt-6">
        ...
        <p className="text-sm text-cami-300">Los plazos y condiciones de entrega se describen en nuestra <a href="/politica-de-envios" className="text-cami-200 underline">Política de Envíos</a>. Debido a la naturaleza personalizada de muchos productos, las devoluciones solo se aceptan por defectos de fabricación o errores imputables a Camiart; para el resto de casos consultar condiciones específicas en la política de devolución incluida en la confirmación del pedido.</p>
      </section>

      <section className="mt-6">
        <h2 className="text-xl font-semibold text-white">7. Garantía</h2>
        <p className="text-sm text-cami-300">Nuestros productos cuentan con la garantía legal frente a defectos de conformidad según la legislación vigente. Para ejercer la garantía, contacta con <a href="mailto:help@camiart.com" className="text-cami-200 underline">help@camiart.com</a> y facilita la información del pedido y fotografías.</p>
      </section>
