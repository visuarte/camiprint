  ...
  useEffect(() => {
    ...
    const initialize = async () => {
      const [THREE, { GLTFLoader }, { OrbitControls }, { DecalGeometry }] = await Promise.all([
        import(/* webpackIgnore: true */ `${THREE_CDN}/build/three.module.js`),
        import(/* webpackIgnore: true */ `${THREE_CDN}/examples/jsm/loaders/GLTFLoader.js`),
        import(/* webpackIgnore: true */ `${THREE_CDN}/examples/jsm/controls/OrbitControls.js`),
        import(/* webpackIgnore: true */ `${THREE_CDN}/examples/jsm/geometries/DecalGeometry.js`),
      ]);
